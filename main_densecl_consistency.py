...
from models.densecl_consistency import DenseCL_Consistency
from models.loader import ContrastiveDataset
...
parser.add_argument('--loss_alpha', type=float, default=0.03, help='')

parser.add_argument('--temperature', type=float, default=0.2, help='temperature value for contrastive loss')
parser.add_argument('--tau', type=float, default=0.04, help='temperature value for consistency loss')
...
def main_worker(rank, world_size, args):
    ...
    model = DenseCL_Consistency(
        ...
        args.queue_len, args.feature_dim, args.momentum, args.loss_lambda, args.temperature,
        args.tau, args.loss_alpha
    )
    ...
    dataset = ContrastiveDataset(args.path, distortion)
